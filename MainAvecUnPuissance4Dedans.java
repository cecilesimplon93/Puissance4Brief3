...
// et je les déclare ici pour pouvoir y accéder de partout depuis cette Main
	...
	int tourDeJeu = 0; // pour ne pas se battre pour savoir à qui c'est de jouer
...
// je t'avais dit que je reviendrais....
	...
	public static void main(String[] args) {
		...
		// là je crée un machin pour pouvoir appeler les fonctions présentes dans la
		// dite main
		...
		System.out.println("Mouais, pas mal comme prénom...");
...
//on va monter et initialiser le tableau
		...
		;
		// affichage du tableau de début de jeu :
		...
		// les félicitations qui s'imposent
